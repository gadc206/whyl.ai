...
(function () {
  ...
  const WORKING_STATUS_WORDS = [
    ...
    // Real Launch Gallery company creatives: opening hooks + full videos.
  // Sorted short→long so wait-fit picks the longest real video that fits.
  const LAUNCH_CREATIVE_FILES = [
    { id: 'lg-factory-3s', advertiserName: 'Factory', advertiserUrl: 'https://factory.ai', title: 'Factory 2.0', slogan: 'From coding agents to software factories.', description: 'Launch Gallery opening hook.', file: 'media/factory-3s.mp4', contentType: 'video', creditsPerView: 1, durationSeconds: 3 },
    { id: 'lg-lightwork-4s', advertiserName: 'Lightwork', advertiserUrl: 'https://lightwork.ai', title: 'Introducing Lightwork', slogan: 'Work that moves itself.', description: 'Launch Gallery opening hook.', file: 'media/lightwork-4s.mp4', contentType: 'video', creditsPerView: 1, durationSeconds: 4 },
    { id: 'lg-3jane-5s', advertiserName: '3Jane', advertiserUrl: 'https://3jane.xyz', title: '3Jane is now open to the public', slogan: 'Open to the public.', description: 'Launch Gallery opening hook.', file: 'media/3jane-5s.mp4', contentType: 'video', creditsPerView: 1, durationSeconds: 5 },
    { id: 'lg-pear-6s', advertiserName: 'Pear', advertiserUrl: 'https://pear.trade', title: 'One account. Every market.', slogan: 'One account. Every market.', description: 'Launch Gallery opening hook.', file: 'media/pear-6s.mp4', contentType: 'video', creditsPerView: 1, durationSeconds: 6 },
    { id: 'lg-switchlabs-7s', advertiserName: 'TheSwitchLabs', advertiserUrl: 'https://theswitchlabs.com', title: 'You Do The Building. We Handle The Distribution.', slogan: 'You build. We distribute.', description: 'Launch Gallery opening hook.', file: 'media/switchlabs-7s.mp4', contentType: 'video', creditsPerView: 1, durationSeconds: 7 },
    { id: 'lg-collective-8s', advertiserName: 'The Collective', advertiserUrl: 'https://launchgallery.video/video/the-collective-launching-the-collective-platform-for-young-founders-builders/', title: 'Launching The Collective', slogan: 'Platform for young founders & builders.', description: 'Launch Gallery opening hook.', file: 'media/collective-8s.mp4', contentType: 'video', creditsPerView: 1, durationSeconds: 8 },
    { id: 'lg-stitch-9s', advertiserName: 'Stitch', advertiserUrl: 'https://launchgallery.video/video/stitch-stitch-pressure-free-mini-vlog-app-for-shy-introverts/', title: 'Stitch', slogan: 'Pressure-free mini-vlogs for shy introverts.', description: 'Launch Gallery opening hook.', file: 'media/stitch-9s.mp4', contentType: 'video', creditsPerView: 1, durationSeconds: 9 },
    { id: 'lg-crowdreply-10s', advertiserName: 'CrowdReply', advertiserUrl: 'https://crowdreply.io', title: 'Searchmaxxing', slogan: 'Be visible in AI answers.', description: 'Launch Gallery opening hook.', file: 'media/crowdreply-10s.mp4', contentType: 'video', creditsPerView: 2, durationSeconds: 10 },
    { id: 'lg-kaito-12s', advertiserName: 'Kaito AI', advertiserUrl: 'https://kaito.ai', title: 'Influence mapping to 1M users', slogan: 'Expanding influence mapping to 1M users.', description: 'Launch Gallery opening hook.', file: 'media/kaito-12s.mp4', contentType: 'video', creditsPerView: 2, durationSeconds: 12 },
    { id: 'lg-synclabs-15s', advertiserName: 'Sync Labs', advertiserUrl: 'https://synclabs.so', title: 'Lipsync Technology Now in Production', slogan: 'Lipsync in production to unlock stories.', description: 'Launch Gallery opening hook.', file: 'media/synclabs-15s.mp4', contentType: 'video', creditsPerView: 3, durationSeconds: 15 },
