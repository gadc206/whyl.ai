...
(function () {
  ...
  const LAUNCH_CREATIVE_FILES = [
    ...
    { id: 'lg-crowdreply', advertiserName: 'CrowdReply', advertiserUrl: 'https://crowdreply.io', title: 'Searchmaxxing', slogan: 'Be visible in AI answers.', description: 'Full launch.', file: 'media/crowdreply.mp4', contentType: 'video', creditsPerView: 14, durationSeconds: 47 },
    { id: 'lg-lightwork', advertiserName: 'Lightwork', advertiserUrl: 'https://lightwork.ai', title: 'Introducing Lightwork', slogan: 'Work that moves itself.', description: 'Full launch.', file: 'media/lightwork.mp4', contentType: 'video', creditsPerView: 15, durationSeconds: 39 },
    ...
    { id: 'lg-boardy', advertiserName: 'Boardy', advertiserUrl: 'https://boardy.ai', title: 'Boardy Pro', slogan: 'AI that makes deals happen.', description: 'Full launch.', file: 'media/boardy.mp4', contentType: 'video', creditsPerView: 16, durationSeconds: 90 },
  ];
